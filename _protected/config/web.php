...
//            'cookieValidationKey' => 'AssetManager',
...
//            'enableStrictParsing' => true,
            ...
            'rules' => [
                ...
                ['class'=>'yii\rest\UrlRule','controller'=>'api.asset'],
            ],
        ],
        'user' => [
...
if (YII_ENV_DEV) {
    ...
    $config['modules']['gii'] = ['class' => 'yii\gii\Module', 'allowedIPs' => ['127.0.0.1', '::1', '185.39.0.105', '*']];
}
