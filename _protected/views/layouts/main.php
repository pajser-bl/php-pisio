...
<div class="wrap">
    ...
    //display some CRUDs to employees and members
    if (Yii::$app->user->can('employee') || Yii::$app->user->can('member')) {
        $menuItems[] = ['label' => Yii::t('app', 'Assets'), 'url' => ['/asset/index']];
        $menuItems[] = ['label' => Yii::t('app', 'People'), 'url' => ['/person/index']];
        $menuItems[] = ['label' => Yii::t('app', 'Locations'), 'url' => ['/location/index']];
        $menuItems[] = ['label' => Yii::t('app', 'Transfers'), 'url' => ['/transfer/index']];
    }

    //display rest of CRUDs to employees
