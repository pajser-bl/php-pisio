    ...
    echo TabularForm::widget([
        ...
        'attributes' => [
            ...
            'person_from' => [
                ...
                'options' => [
                    'data' => \yii\helpers\ArrayHelper::map(\app\models\Person::find()->orderBy('title')->asArray()->all(), 'id', function ($model) {
            ...
            'location_from' => [
                ...
                'options' => [
                    ...
                    'options' => ['placeholder' => 'Choose Location', 'hideSearch' => true],
                ],
                'columnOptions' => ['width' => '200px']
            ],
            'location_to' => [
